								...
								<div class="widget-main no-padding">
									<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 실행 함수명 </label>
												<div class="col-sm-9">
													<input type="text" id="menuFunc" name="menuFunc" class="col-xs-10 col-sm-5" value="" readonly="readonly" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" id="roles" name="roles" class="col-xs-10 col-sm-11" value="" readonly="readonly" />
												</div>
											</div>
				...
				<div class="modal-body overflow-visible">
					<div class="row">
						<div class="form-horizontal">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right">실행 함수명</label>
								<div class="col-sm-9">
									<input class="col-xs-12" type="text" id="menuFunc" value="" onkeyup="javascript:fnCheckStrLength(this, 45)"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select multiple="" class="width-98 chosen-select" id="roles" name="roles" data-placeholder="권한을 선택하세요."></select>
								</div>
							</div> 
